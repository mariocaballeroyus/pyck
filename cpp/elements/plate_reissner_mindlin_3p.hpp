...
public:
     ...
     */
    Matrix<T> bending_constitutive_matrix(const LocalFrame<T, 2>& local, Index q) const override;
     ...
     */
    Matrix<T> shear_constitutive_matrix(const LocalFrame<T, 2>& local, Index q) const override;
