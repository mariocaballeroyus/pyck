...
class LagrangeMultiplierCondition:
    ...
    def bind(self, _: "QuadratureRule", element: "Element") -> None:
        ...
        cpp = _pyck.LagrangeMultiplierCondition2d(
    ...
    def __repr__(self) -> str:
        return f"LagrangeMultiplierCondition(num_fields={len(self._terms)})"
...
def create_displacement_lagrange(
    ...
    cond = LagrangeMultiplierCondition(boundary, quadrature)
    cond.add("w", value_w)
    return cond
