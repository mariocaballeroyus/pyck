...
class PenaltyCouplingCondition2d(Condition2d):
    ...
    def couple_kinematics(self, penalty_disp: typing.SupportsFloat | typing.SupportsIndex, penalty_rot: typing.SupportsFloat | typing.SupportsIndex) -> PenaltyCouplingCondition2d:
        ...
class MixedMembraneStrainShell(Element2d):
    def __init__(self, patch: Patch2d, base_element: Element2d, quadrature: QuadratureRule2d, degree_drop: int = 1) -> None:
        ...
    def recover_membrane_force(self, full_u: numpy.typing.NDArray[numpy.float64], params: numpy.typing.NDArray[numpy.float64]) -> numpy.typing.NDArray[numpy.float64]:
        ...
...
class ShellReissnerMindlinHier5p(Element2d):
    def __init__(self, material: PlaneStress2d) -> None:
        ...
class ShellReissnerMindlinHier5pDispl(Element2d):
    def __init__(self, material: PlaneStress2d) -> None:
        ...
