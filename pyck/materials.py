...
class PlaneStress2d:
    ...
    """
    def __init__(self, E: float, nu: float = 0.3, h: float = 1.0) -> None:
        self._E = float(E)
        self._nu = float(nu)
        self._h = float(h)
        self._cpp_object = _pyck.PlaneStress2d(self._E, self._nu, self._h)
    ...
    def __repr__(self) -> str:
        return f"PlaneStress2d(E={self._E}, nu={self._nu}, h={self._h})"
